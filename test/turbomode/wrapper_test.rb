...
describe Wrapper do
  ...
  describe :get_mouse_x do 
    it "should return window's mouse_x" do
      ...
      _(wrapper.get_mouse_x).must_equal 123
      window.verify
    end
  end
  ...
  describe :get_mouse_y do 
    it "should return window's mouse_y" do
      ...
      _(wrapper.get_mouse_y).must_equal 321
      window.verify
    end
  end
  ...
  describe :get_color do
    it "should return gosu constant when available" do
      _(wrapper.get_color(:aqua)).must_equal Gosu::Color::AQUA
    end

    it "should return white if color not available" do
      _(wrapper.get_color(:bla)).must_equal Gosu::Color::WHITE
    end
  end
  ...
  describe :get_key do
    ...
    it "should raise exception if value not available" do
      _(-> { wrapper.get_key(:whatever) }).must_raise NameError
    end
  end
end
